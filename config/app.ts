...
export const database = {
  connection: 'mysql', // Change this to your preferred database connection
  mysql: {
    client: 'mysql',
    connection: {
      host: Env.get('DB_HOST', '127.0.0.1'),
      port: Env.get('DB_PORT', 3306),
      user: Env.get('DB_USER', 'Nivesh'),
      password: Env.get('DB_PASSWORD', 'Nivesh@123'),
      database: Env.get('DB_DATABASE', 'TEST_DATABASE'),
    },
  },
};
